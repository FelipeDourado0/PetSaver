...
public abstract class Hilt_BemVindoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BemVindoFragment() {
    super();
  }

  Hilt_BemVindoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BemVindoFragment_GeneratedInjector) this.generatedComponent()).injectBemVindoFragment(UnsafeCasts.<BemVindoFragment>unsafeCast(this));
    }
  }
