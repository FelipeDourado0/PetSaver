...
abstract class MateriasRepositoryModule {
    ...
    @Singleton
    @Binds
    abstract fun providesMateriasRepository(implementation: com.petsaverapp.core.data.repository.MateriaRepository): com.petsaverapp.core.data.repository.IMateriasRepository
}