...
public final class ItemListVocesabiaHomeBinding implements ViewBinding {
  @NonNull
  ...
  private ItemListVocesabiaHomeBinding(@NonNull ConstraintLayout rootView,
      @NonNull CardView cardViewHome, @NonNull ImageView detalheFundo,
      @NonNull ImageView imageBackGround, @NonNull ShapeableImageView photoPerfil,
      @NonNull TextView subTitleItemCard, @NonNull TextView titleItemCard) {
  ...
  @NonNull
  public static ItemListVocesabiaHomeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemListVocesabiaHomeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_list_vocesabia_home, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemListVocesabiaHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemListVocesabiaHomeBinding((ConstraintLayout) rootView, cardViewHome,
          detalheFundo, imageBackGround, photoPerfil, subTitleItemCard, titleItemCard);
    }
