...
public abstract class Hilt_MateriaDetalheFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MateriaDetalheFragment() {
    super();
  }

  Hilt_MateriaDetalheFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MateriaDetalheFragment_GeneratedInjector) this.generatedComponent()).injectMateriaDetalheFragment(UnsafeCasts.<MateriaDetalheFragment>unsafeCast(this));
    }
  }
